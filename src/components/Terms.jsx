function Terms() {
  return (
    <div className="privacy">
      <h3 className="text-[32px] font-sans font-bold text-[#404040] mt-[35px] mb-[35px]">
        Terms & Conditions
      </h3>
      <p>AGREEMENT TO OUR LEGAL TERMS</p>
      <li>
        We are campfly private limited ("Company," "we," "us," "our"), a company
        registered in India at 104, S Janatha Rd, Palarivattom, Kochi, Kerala
        682025, India, Kochi, Kerala 682025.
      </li>
      <li>
        We operate the website https://campfly.in (the "Site"), as well as any
        other related products and services that refer or link to these legal
        terms (the "Legal Terms") (collectively, the "Services").
      </li>
      <li>
        You can contact us by phone at (+91)8891999253, email at
        info@campfly.in, or by mail to 104, S Janatha Rd, Palarivattom, Kochi,
        Kerala 682025, India, Kochi, Kerala 682025, India.
      </li>
      <li>
        These Legal Terms constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity ("you"), and campfly
        private limited, concerning your access to and use of the Services. You
      ...
      <ol class="list-decimal ml-4 mb-[20px]">
        <li>OUR SERVICES</li>
      ...
      <li>solely for your internal business purpose.</li>
      <li>
      ...
      <li>
        ...
        address your request to: info@campfly.in. If we ever grant you the
      ...
      <li>
        ...
        the contact details below costumer care : 8891999253
      </li>
      ...
      <li>
        ...
        Policy: https://campfly.in/privacy. By using the Services, you agree to
        be bound by our Privacy Policy, which is incorporated into these Legal
        Terms. Please be advised the Services are hosted in India. If you access
      ...
      <li>
        ...
        India. campfly private limited and yourself irrevocably consent that the
      ...
      <li>
        ...
        be three (3). The seat, or legal place, or arbitration shall be kochi,
      ...
      <li>
        ...
        campfly private limited 104, S Janatha Rd, Palarivattom, Kochi, Kerala
        682025, India Kochi, Kerala 682025 India
      </li>
      <p className="text-[16px]">
        Phone: <span className="text-[#161EDD] text-[16px]">(+91)8891999253</span>
      </p>
      <p className="text-[#161EDD] important">info@campfly.in</p>
    </div>
  );
}
